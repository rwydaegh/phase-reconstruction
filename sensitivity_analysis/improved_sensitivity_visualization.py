...
def create_enhanced_rmse_plot(X, Y, rmse, param1_name, param2_name, save_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(save_dir, f"enhanced_{param1_name}_vs_{param2_name}_rmse.png"), dpi=300)
    plt.close(fig)
...
def create_correlation_quality_map(X, Y, correlation, param1_name, param2_name, save_dir):
    ...
    cmap = plt.colormaps['RdYlGn'].resampled(len(thresholds) - 1)  # Use discrete colormap with specific number of levels
