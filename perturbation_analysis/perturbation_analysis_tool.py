...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Verify perturbation effect on field reconstruction")
    ...
    parser.add_argument('--output-dir', type=str, default='perturbation_analysis/plots', 
