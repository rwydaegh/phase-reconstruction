...
from src.visualization import visualize_fields, visualize_iteration_history, visualize_current_and_field_history
    ...
    if config.return_history:
        ...
        if not config.no_anim:
            ...
            visualize_iteration_history(
                ...
                convergence_threshold=config.convergence_threshold,
                measured_magnitude=measured_magnitude  # Pass the measured magnitude for true error calculation
            )
...
if __name__ == "__main__":
    try:
        ...
        parser = argparse.ArgumentParser(description='Run field reconstruction simulation with refactored phase retrieval')
