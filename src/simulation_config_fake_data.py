...
class SimulationConfig(BaseConfig):
    ...
    resolution: int = 50         # 50x50 grid
    room_size: float = 2.0       # 2m x 2m x 2m room
    
    # Point cloud parameters
    use_source_pointcloud: bool = False  # Whether to use the source pointcloud file
    ...
    max_distance_from_origin: float = np.inf  # Maximum distance from origin (in meters) to keep points
    ...
    perturbation_factor: float = 0.02  # Max perturbation as percentage of distance to origin
    ...
    enable_perturbations: bool = False  # Enable perturbation strategies (derived from perturbation_mode != "none")
    ...
    enable_smoothing: bool = False    # Enable Gaussian smoothing as post-processing
    smoothing_radius_mm: float = 0.0  # Radius in mm for Gaussian smoothing
