...
class SimulationConfig(BaseConfig):
    ...
    use_source_pointcloud: bool = False
    source_pointcloud_path: str = "measurrment_data/source_pointcloud.pkl"
    ...
    perturbation_factor: float = 0.02
